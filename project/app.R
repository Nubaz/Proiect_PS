  ...
  sidebarLayout(
    sidebarPanel(
      ...
      conditionalPanel(
        ...
        sliderInput("gamma_x", "Număr valori:", min = 4, max = 100, value = 20),
        numericInput("gamma_k", "k:", min = 1, value = 2),
        numericInput("gamma_t", "teta:", min = 1, value = 2)
      ),
      ...
      conditionalPanel(
        ...
        sliderInput("pois_x", "Număr evenimente", min = 3, max = 50, value = 25),
        numericInput("pois_lambda", "Lambda", min = 1, max = 50, value = 4)
      ),
